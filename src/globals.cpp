...
QString suffixToIconName(QString suffix)
{
    ...
    if (suffix == "txt" || suffix == "doc" || suffix == "docx" || suffix == "xls" || suffix == "xlsx" || suffix == "pdf")
        return "file-txt";
    if (suffix == "rpm")
        return "file-rpm";
    if (suffix == "apk")
        return "file-apk";
    if (suffix == "png" || suffix == "jpeg" || suffix == "jpg" || suffix == "gif" || suffix == "svg")
        return "file-image";
    if (suffix == "wav" || suffix == "mp3" || suffix == "flac" || suffix == "aac" || suffix == "ogg" || suffix == "m4a")
        return "file-audio";
